...
contract ArbitrageBotV2 is FlashLoanSimpleReceiverBase, Ownable {
    ...
    function executeArbitrage(
        ...
        amountOut = checkArbitrage(router0, router1, token0, token1, amountIn, expectedAmountOut);

        require(expectedAmountOut > amountOut && amountOut > (expectedAmountOut - amountIn), "Arbitrage: No opportunity found");
